...
public class Test {
	...
	public static void main(String[] args) throws SQLException, ParseException, ClassNotFoundException {
		...
		String entrada = "1995-12-17";
		Date fecha = form.parse(entrada);
		
		AsistenteDAO asist = new AsistenteDAO();			
		AsistenteJB userasist = new AsistenteJB();
		//AsistenteJB userasist2 = new AsistenteJB("ABC002","Laura","Sanchez","Cordoba",27,fecha,"Licenciatura","(229) 336-65-94","4321");
